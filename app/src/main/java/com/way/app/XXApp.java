...
public class XXApp extends Application {
    ...
    private Map<String, Integer> mFnsMap = new LinkedHashMap<String, Integer>();
    ...
    public Map<String, Integer> getFnsMap() {
        if (!mFnsMap.isEmpty())
            return mFnsMap;
        return null;
    }

    private void initFnsMap() {
        mFnsMap.put("#图片#", R.drawable.fns_00);
		mFnsMap.put("#宠物#", R.drawable.fns_01);
    }
