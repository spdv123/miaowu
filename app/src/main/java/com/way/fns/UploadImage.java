...
public class UploadImage {
    ...
    public static String uploadFile2(File file,String RequestURL) {
        ...
        try {
            ...
            HttpURLConnection conn = (HttpURLConnection) url.openConnection(); conn.setReadTimeout(TIME_OUT); conn.setConnectTimeout(TIME_OUT);             conn.setDoInput(true); //允许输入流
            ...
            if(file!=null) {
                ...
                sb.append("Content-Type: image/gif; charset="+CHARSET+LINE_END);
                sb.append(LINE_END);
                ...
                if(res==200)
                {
                    return getStringFromIS((InputStream) conn.getContent());
                }
            }
    ...
    public static String getStringFromIS(InputStream ist) {
        BufferedReader reader =
                new BufferedReader(new InputStreamReader(ist));
    ...
    public static String uploadFile(File file,String RequestURL)
    {
        ...
        try
        {
            URL url = new URL(setting.UploadURL);
